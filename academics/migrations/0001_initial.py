...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('semester_number', models.IntegerField(help_text='Enter the semester number (1-8 for BS programs)', validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(8)])),
                ('semester_type', models.CharField(choices=[('fall', 'Fall Semester'), ('spring', 'Spring Semester')], help_text='Select whether this is a Fall or Spring semester', max_length=10)),
                ...
                ('registration_start', models.DateField(help_text='Select the date when course registration opens for this semester')),
                ('registration_end', models.DateField(help_text='Select the deadline for course registration in this semester')),
                ('classes_start', models.DateField(help_text='Select the date when classes begin for this semester')),
                ('mid_term_start', models.DateField(help_text='Select the starting date of mid-term examinations')),
                ('mid_term_end', models.DateField(help_text='Select the ending date of mid-term examinations')),
                ('final_term_start', models.DateField(help_text='Select the starting date of final examinations')),
                ('final_term_end', models.DateField(help_text='Select the ending date of final examinations')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ],
            options={
