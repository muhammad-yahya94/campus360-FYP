# Generated by Django 5.2.3 on 2025-07-19 03:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('male', 'Male'), ('female', 'Female')], help_text='Select the gender of the applicant.', max_length=6)),
                ...
                ('shift', models.CharField(choices=[('morning', 'Morning'), ('evening', 'Evening')], help_text='Select the preferred shift for the program.', max_length=10)),
                ...
                ('rejection_reason', models.TextField(blank=True, help_text='Reason for rejection if application is rejected.', null=True)),
                ...
                ('session', models.ForeignKey(blank=True, help_text='Select the academic session this applicant applied for.', null=True, on_delete=django.db.models.deletion.CASCADE, to='admissions.academicsession')),
                ('user', models.ForeignKey(help_text='Select the user account associated with this applicant.', on_delete=django.db.models.deletion.CASCADE, related_name='applications', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('applicant', models.ForeignKey(help_text='Select the applicant for this academic qualification.', on_delete=django.db.models.deletion.CASCADE, related_name='academic_qualifications', to='admissions.applicant')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('applicant', models.ForeignKey(help_text='Select the applicant for this activity record.', on_delete=django.db.models.deletion.CASCADE, related_name='extra_curricular_activities', to='admissions.applicant')),
            ],
        ),
    ]
