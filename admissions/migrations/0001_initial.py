    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Enter the name of the academic session (e.g., Fall 2024, Spring 2025).', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('institute', models.CharField(help_text='Enter the name of the school, college, or university attended.', max_length=200)),
                ('board', models.CharField(blank=True, help_text='Enter the name of the examining board or university (optional).', max_length=200)),
                ('level', models.CharField(default='N/A', help_text='Enter the academic level of this qualification (e.g., Matric, Intermediate, Bachelor). Optional, defaults to N/A.', max_length=50)),
